...
function App() {
  ...
  <div className='col-md-12 col-12 '>
    <h2 style={{fontWeight:`bolder`}} className='text-dark text-center  font gradient-text1'>K Rakesh Reddy</h2>
    <h6 className='text-dark text-center font gradient-text1'>kandhalarakesh007@gmail.com</h6>
    <h6 className='text-dark text-center  font gradient-text1'>9110342725</h6>
    <h6 className='text-dark text-center  font gradient-text1'>Sriramnagar,Suryapet,508213</h6>
  </div>
</div>
...
<div class="row d-flex justify-content-center align-items-center">
  <div class="col-12 col-md-auto text-center mb-2 mb-md-0">
    <a href="https://www.linkedin.com/in/rakesh-reddy-53501222a/" class="btn btn-primary btn-sm">
      <i class="fa fa-linkedin" aria-hidden="true"></i>&nbsp;Linkedin
    </a>
  </div>
  <div class="col-12 col-md-auto text-center mb-2 mb-md-0">
    <a href="https://github.com/RakeshRocky220" class="btn btn-danger btn-sm mx-2">
      <i class="fa fa-github" aria-hidden="true"></i>&nbsp;Github
    </a>
  </div>
  <div class="col-12 col-md-auto text-center">
    <a href="https://www.hackerrank.com/kandhalarakeshr1" class="btn btn-success btn-sm">
      <img src={image} style={{height: "25px", width: "25px"}} />&nbsp;HackerRank
    </a>
  </div>
</div>
   ...
   <br></br>
   <h2 className="mx-2 text-dark font gradient-text" style={{fontWeight:`bolder`}}>
 ...
 &nbsp; <span className="gradient-text" >Education :</span>
  ...
  <div className='row mt-2'>
      <div className='col-md-6'>
        <h5 style={{fontWeight:`bolder`}} className='mx-2 text-dark font'>Malla Reddy Institute of Engineering and Technology</h5>
        <h6 className='mx-2 text-dark font'>B Tech in Information Technology (2018-2022)</h6>
        <h6 className='mx-2 text-dark font'>CGPA : 6.7</h6>
        <br></br>
        <h5 style={{fontWeight:`bolder`}} className='mx-2 text-dark font'>Narayana Junior College</h5>
        <h6 className='mx-2 text-dark font'>Intermediate in MPC (2016-2018)</h6>
        <h6 className='mx-2 text-dark font'>Percentage : 97%</h6>
      </div>
  </div>
  
    <br></br>
   <h2 style={{fontWeight:`bolder`}} className='mx-2 text-dark gradient-text font'><i class="fa fa-certificate" aria-hidden="true"></i>&nbsp;&nbsp;<span className='gradient-text'>Certifications :</span></h2>
   <hr className='text-dark'></hr>

   <div className='row'>
      <div className='col-md-6'>
        <h6 className='text-dark mx-2'>- Problem Solving ( Basic ) - <b>HackerRank</b></h6>
        <h6 className='text-dark mx-2'>- Java ( Basic ) - <b>HackerRank</b></h6>
        <h6 className='text-dark mx-2'>- SQL ( Basic ) - <b>HackerRank</b></h6>
        <h6 className='text-dark mx-2'>- Java Script ( Basic ) - <b>HackerRank</b></h6>
        <a href='https://www.hackerrank.com/certificates/cbfca2a02191'><button className='btn btn-outline-success mx-3 mt-2'>View Credentials</button></a>
      </div>
   </div>

   <br></br>
   <h2 style={{fontWeight:`bolder`}} className='mx-2 text-dark gradient-text font'>&nbsp;<span className='gradient-text '>Skills :</span></h2>
   <hr  className='text-dark'></hr>
